...
from tensorflow.keras.utils.data_utlis import get_file
from tensorflow.keras import backend as K
from keras_frcnn.roi_poiling_conv import RoiPoolingConv
...
def nn_base(input_tnsor=None, trainable=False):
